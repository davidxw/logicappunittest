...
namespace app
{
    ...
    /// <summary>
    /// Represents the functionApp flow invoked function.
    /// </summary>
    public class functionApp
    {
        ...
        {
            logger = loggerFactory.CreateLogger<functionApp>();
        }
        ...
        {
            this.logger.LogInformation("Starting functionApp with Zip Code: " + zipCode + " and Scale: " + temperatureScale);
        ...
        /// <summary>
        /// Represents the weather information for functionApp.
        /// </summary>
